...
\hat{q}_{k,out}(t) 
  ...
  +
    ...
    \int^{\infty}_{-\infty}
    dt'
    \sin\left(\omega_{\underline{k}}(t-t') \right) \tilde{j}(k,t')
  .}
\end{equation}
...
\hat{q}_{k,out}(t) 
  ...
  +
  	...
  	\bar{j_{\underline{k}}}(\omega_{\underline{k}})
\end{equation}
From this equation we can obtain the connection between creation and annihilation operators.
\begin{subequations}
\begin{align}
\hat{a}_{k,Out}=  \hat{a}_{k,in}+i\bar{j_{\underline{k}}}(\omega_{\underline{k}})  
&\\
\hat{a}^{\dagger}_{\underline{k},out} = \hat{a}^{\dagger}_{\underline{k},in}-i\bar{j_{\underline{k}}}(-\omega_{\underline{k}})  
\end{align}
\end{subequations}
...
\begin{equation}
S^{-1}\hat{a}_{k,in}S=\hat{a}_{k,Out}=\hat{a}_{\underline{k},in} +i\ \bar{j_{\underline{k}}}(\omega_{\underline{k}})
\end{equation}
%
%
