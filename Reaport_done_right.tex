...
\end{equation} 
The unitary operator $ U $ itself satisfies the equation
\begin{equation}
\textcolor[RGB]{0,0,204}{
...
The third picture is called the Interaction picture (sometimes called the Dirac picture). It denotes the time dependence to the state as well as to the operators.\\
Suppose $ \hat{H} = \hat{H}_{0}+V$ . This will effect the unitary operator so 
...
Let's consider $ V=j(t)\hat{q}(t) $ with $ \hat{q}(t) $ as the operator of position and $ j $ an external source.\\
This term will lead to a poissonian probability distribution for the excitation of of states, especially the vacuum or ground states of a system. Resulting in an unstable vacuum. But for experiments and calculations we have asymptotic states, meaning we can distinguish between states and/or particles. This fits the observation of a stable vacuum without external influences. With asymptotic conditions on $ j(t) $ . We assume it vanishes outside of finite intervals. 
\begin{equation}
\textcolor[RGB]{0,0,204}{
